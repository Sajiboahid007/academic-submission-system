...
// node_modules/ngx-flexible-layout/fesm2022/ngx-flexible-layout-_private-utils.mjs
...
// node_modules/ngx-flexible-layout/fesm2022/ngx-flexible-layout-core.mjs
...
var StylesheetMap = class _StylesheetMap {
  ...
  static ɵfac = function StylesheetMap_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _StylesheetMap)();
  };
  static ɵprov = ɵɵdefineInjectable({
    token: _StylesheetMap,
    factory: _StylesheetMap.ɵfac,
    providedIn: "root"
  });
};
(() => {
...
var StyleUtils = class _StyleUtils {
  _serverStylesheet;
  _serverModuleLoaded;
  _platformId;
  layoutConfig;
  ...
  static ɵfac = function StyleUtils_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _StyleUtils)(ɵɵinject(StylesheetMap), ɵɵinject(SERVER_TOKEN), ɵɵinject(PLATFORM_ID), ɵɵinject(LAYOUT_CONFIG));
  };
  static ɵprov = ɵɵdefineInjectable({
    token: _StyleUtils,
    factory: _StyleUtils.ɵfac,
    providedIn: "root"
  });
};
(() => {
...
var MatchMedia = class _MatchMedia {
  _zone;
  _platformId;
  _document;
  _cspNonce;
  ...
  constructor(_zone, _platformId, _document, _cspNonce) {
    this._zone = _zone;
    this._platformId = _platformId;
    this._document = _document;
    this._cspNonce = _cspNonce;
  }
  /**
  ...
  static ɵfac = function MatchMedia_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _MatchMedia)(ɵɵinject(NgZone), ɵɵinject(PLATFORM_ID), ɵɵinject(DOCUMENT), ɵɵinject(CSP_NONCE, 8));
  };
  static ɵprov = ɵɵdefineInjectable({
    token: _MatchMedia,
    factory: _MatchMedia.ɵfac,
    providedIn: "root"
  });
};
(() => {
...
var ALL_STYLES = {};
function buildQueryCss(mediaQueries, _document, _cspNonce) {
...
var BREAKPOINTS = new InjectionToken("Token (ngx-flexible-layout) Breakpoints", {
  providedIn: "root",
  factory: () => {
...
var BreakPointRegistry = class _BreakPointRegistry {
  items;
  constructor(list) {
   ...
   */
  findByMap = /* @__PURE__ */ new Map();
  static ɵfac = function BreakPointRegistry_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _BreakPointRegistry)(ɵɵinject(BREAKPOINTS));
  };
  static ɵprov = ɵɵdefineInjectable({
    token: _BreakPointRegistry,
    factory: _BreakPointRegistry.ɵfac,
    providedIn: "root"
  });
};
(() => {
...
var PrintHook = class _PrintHook {
  breakpoints;
  layoutConfig;
  _document;
  ...
  deactivations = [];
  static ɵfac = function PrintHook_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _PrintHook)(ɵɵinject(BreakPointRegistry), ɵɵinject(LAYOUT_CONFIG), ɵɵinject(DOCUMENT));
  };
  static ɵprov = ɵɵdefineInjectable({
    token: _PrintHook,
    factory: _PrintHook.ɵfac,
    providedIn: "root"
  });
};
(() => {
...
var MediaMarshaller = class _MediaMarshaller {
  matchMedia;
  breakpoints;
  hook;
  _useFallbacks = true;
  _activatedBreakpoints = [];
  elementMap = /* @__PURE__ */ new Map();
  elementKeyMap = /* @__PURE__ */ new WeakMap();
  watcherMap = /* @__PURE__ */ new WeakMap();
  // special triggers to update elements
  updateMap = /* @__PURE__ */ new WeakMap();
  // callback functions to update styles
  clearMap = /* @__PURE__ */ new WeakMap();
  ...
  static ɵfac = function MediaMarshaller_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _MediaMarshaller)(ɵɵinject(MatchMedia), ɵɵinject(BreakPointRegistry), ɵɵinject(PrintHook));
  };
  static ɵprov = ɵɵdefineInjectable({
    token: _MediaMarshaller,
    factory: _MediaMarshaller.ɵfac,
    providedIn: "root"
  });
};
(() => {
...
var BaseDirective2 = class _BaseDirective2 {
  elementRef;
  styleBuilder;
  styler;
  marshal;
  ...
  static ɵfac = function BaseDirective2_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _BaseDirective2)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(StyleBuilder), ɵɵdirectiveInject(StyleUtils), ɵɵdirectiveInject(MediaMarshaller));
  };
  static ɵdir = ɵɵdefineDirective({
    type: _BaseDirective2,
...
var MockMatchMedia = class _MockMatchMedia extends MatchMedia {
  _breakpoints;
  autoRegisterQueries = true;
  // Used for testing BreakPoint registrations
  useOverlaps = false;
  // Allow fallback to overlapping mediaQueries
  constructor(_zone, _platformId, _document, _cspNonce, _breakpoints) {
  ...
  static ɵfac = function MockMatchMedia_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _MockMatchMedia)(ɵɵinject(NgZone), ɵɵinject(PLATFORM_ID), ɵɵinject(DOCUMENT), ɵɵinject(CSP_NONCE, 8), ɵɵinject(BreakPointRegistry));
  };
  static ɵprov = ɵɵdefineInjectable({
    token: _MockMatchMedia,
    factory: _MockMatchMedia.ɵfac
  });
};
(() => {
...
var MediaObserver = class _MediaObserver {
  breakpoints;
  matchMedia;
  hook;
  ...
  static ɵfac = function MediaObserver_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _MediaObserver)(ɵɵinject(BreakPointRegistry), ɵɵinject(MatchMedia), ɵɵinject(PrintHook));
  };
  static ɵprov = ɵɵdefineInjectable({
    token: _MediaObserver,
    factory: _MediaObserver.ɵfac,
    providedIn: "root"
  });
};
(() => {
...
var MediaTrigger = class _MediaTrigger {
  breakpoints;
  matchMedia;
  layoutConfig;
  _platformId;
  ...
  hasCachedRegistryMatches = false;
  originalActivations = [];
  originalRegistry = /* @__PURE__ */ new Map();
  resizeSubscription;
  static ɵfac = function MediaTrigger_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _MediaTrigger)(ɵɵinject(BreakPointRegistry), ɵɵinject(MatchMedia), ɵɵinject(LAYOUT_CONFIG), ɵɵinject(PLATFORM_ID), ɵɵinject(DOCUMENT));
  };
  static ɵprov = ɵɵdefineInjectable({
    token: _MediaTrigger,
    factory: _MediaTrigger.ɵfac,
    providedIn: "root"
  });
};
(() => {
...
//# sourceMappingURL=chunk-M34J5UC5.js.map
